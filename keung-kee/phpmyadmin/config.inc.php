...
$cfg['Servers'][$i]['user']          = 'qbuild_keungkee';      // MySQL user
$cfg['Servers'][$i]['password']      = 'adminpass';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = 'qbuild_keungkee';          // If set to a db-name, only
