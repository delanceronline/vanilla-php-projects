...
class TCommon
{
	...
	function SendPasscodeResetEmail($tutor_email, $passcode)
	{
		if($tutor_email != '' && $passcode != '')
		{
			...
			<p>您好，歡迎登入GOODTUTOR！</p><p>我們已經重設了您的登入密碼，以下是新的登入密碼：</p><p><b>'.$passcode.'</b></p><p>請小心保存及保密這個電郵！</p><p>登入網址：http://www.goodtutor.hk/web/tutor_login.php</p><br /><br /><p>謝謝</p><p>GOODTUTOR</p>
			</body></html>';

			$headers  = 'MIME-Version: 1.0' . "\r\n";
			$headers .= 'Content-type: text/html; charset=utf-8' . "\r\n";
			$headers .= "To: Good Tutor <$to>" . "\r\n";
			$headers .= 'From: GOODTUTOR <info@goodtutor.hk>' . "\r\n";
	...
	function SendTutorActivationEmail($tutor_email, $passcode)
	{
		if($tutor_email != '' && $passcode != '')
		{
			...
			<p>您好，歡迎加入GOODTUTOR！</p><p>我們已經核實了您的導師身份，以下是您的登入密碼：</p><p><b>'.$passcode.'</b></p><p>請小心保存及保密這個電郵！</p><p>登入網址：http://www.goodtutor.hk/web/tutor_login.php</p><br /><br /><p>謝謝</p><p>GOODTUTOR</p>
			</body></html>';
	...
	function VerifyTutorByEmail(&$connector, $tutor_id, $tutor_email, $passcode)
	{
		if($connector && $tutor_id > 0 && $tutor_email != '' && $passcode != '')
		{
			...
			if($id > 0)
			{
				...
				<p>您好，歡迎您登記成為GOODTUTOR一份子！請按以下連結核實您的導師登入電郵：</p><p>&nbsp;</p><p>http://www.goodtutor.hk/web/vt.php?ti='.$ti.'&amp;code='.$code.'</p><p>&nbsp;</p><p>您的登入密碼：<b>'.$passcode.'</b></p><p>電郵及導師資料一經核實後，我們會盡力為您介紹合適的學生！</p><br /><br /><p>謝謝</p><p>GOODTUTOR</p>
				</body></html>';
