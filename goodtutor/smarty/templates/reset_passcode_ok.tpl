              ...
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="525" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td height="100" valign="middle" bgcolor="#336633"><strong class="hd_white_bold_text">重設密碼</strong> </td>
                    </tr>
                  </table></td>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="750" bgcolor="#FFFADD"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td width="700"><span class="hd_brown_text">密碼更改成功</span><br />
                            <br />
                            <span class="brown_text">新的登入密碼已經由電郵發送到</span><b class="brown_bold_text">{$email}</b><span class="brown_text">，請查閱後再重新登入．</span></td>
                          <td>&nbsp;</td>
                        </tr>
                      </table>
                        <br />
                        ...
                        <br />
                        <br />
                        <span class="brown_underline_text"><a href="index.php" class="brown_underline_text">返回首頁</a></span><br />
                        <br />
                        <br /></td>
