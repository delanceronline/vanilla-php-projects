                    ...
                    <tr>
                      ...
                      <td width="750" bgcolor="#FFFADD"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td>&nbsp;</td>
                          <td width="700"><br />
                            <span class="hd_brown_text">對不起，您的電郵未能被核實！</span><br />
                            <br />
                            <span class="brown_text"><br />
                            </span><br />
                            <br />
                            <br />
                            <br />
                            <br />
                            <a href="javascript: window.close();" class="brown_underline_text">關閉</a><br />
                            <br />
                            <br />
                            <br /></td>
                          <td>&nbsp;</td>
