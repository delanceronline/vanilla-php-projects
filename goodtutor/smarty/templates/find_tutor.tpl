                              ...
                              <tr>
                                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      ...
                                      <td><input name="contact_name" type="text" class="black_text" id="contact_name" value="{$contact_name}" maxlength="64" />
                                    ...
                                    <tr>
                                      ...
                                      <td><input name="contact_no" type="text" class="black_text" id="contact_no" value="{$contact_no}" maxlength="64" />
                                          <span class="required_field_red_star">*</span></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                    ...
                                    <tr>
                                      ...
                                      <td><input name="estate" type="text" class="black_text" id="estate" maxlength="256" /></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
