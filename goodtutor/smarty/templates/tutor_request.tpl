                                ...
                                <table width="700" border="1" cellpadding="0" cellspacing="0" bordercolor="#C09B76">
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td align="center"> {if $client.timeslots[0] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[3] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[6] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[9] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[12] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[15] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[18] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                    </tr>
                                    <tr>
                                      <td height="40" valign="middle" class="brown_bold_text">下午 (2-7:00pm)</td>
                                      <td align="center"> {if $client.timeslots[1] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[4] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[7] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[10] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[13] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[16] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[19] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                    </tr>
                                    <tr>
                                      <td height="40" valign="middle" class="brown_bold_text">晚上 (7-10:00pm)</td>
                                      <td align="center"> {if $client.timeslots[2] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[5] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[8] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[11] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[14] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[17] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                      <td align="center"> {if $client.timeslots[20] == 1}<span class="darkgreen_bold_text">可以</span>{else}<span class="brown_bold_text">---</span>{/if} </td>
                                    </tr>
                                  </tbody>
                                </table>
                                {else}
