                ...
                <tr>
                  <td bgcolor="#61A327"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td valign="middle"><span class="hd_white_bold_text">家長或學生可以透過我們尋找合適的導師；我們絕不會向家長／學生收取任何形式的費用。<br />
                    ...
                    <tr>
                      ...
                      <td width="750" valign="top" bgcolor="#FFFADD"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="700"><br />
                            <br />
                            <span class="hd_brown_text">謝謝您的查詢，我們會盡快為您尋找到合適的導師，並第一時間跟您聯絡！</span><br />
                            <br />
                            <span class="brown_text">如閣下期間有什麼疑問，歡迎您跟我們</span><span class="brown_underline_text"><a href="contact_us.php" class="brown_underline_text">直接聯絡</a></span><span class="brown_text">．</span><span class="brown_bold_text"><br />
                            </span><br />
                            <br />
                            <br />
                            <br />
                            <br />
                            <span class="brown_underline_text"><a href="index.php">返回首頁</a></span><br />
                            <br /></td>
                          <td>&nbsp;</td>
                        </tr>
                      </table>                        </td>
