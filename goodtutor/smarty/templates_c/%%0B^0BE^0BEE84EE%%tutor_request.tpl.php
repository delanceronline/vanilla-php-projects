<?php /* Smarty version 2.6.26, created on 2010-05-30 13:33:50
         compiled from tutor_request.tpl */ ?>
...
unset($_smarty_tpl_vars);
 ?></td>
                    ...
                    <tr>
                      <td height="100" valign="middle" bgcolor="#336633"><img src="images/cases_header.jpg" alt="" width="525" height="90" /></td>
                    </tr>
                  </table></td>
                        ...
                        <tr>
                          ...
                          <td width="700">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td width="140" valign="top"><strong class="brown_bold_underline_text">欲接收的個案詳情</strong></td>
                                <td width="210">&nbsp;</td>
...
<?php else: ?>N/A<?php endif; ?></span></td>
                                ...
                                <table width="700" border="1" cellpadding="0" cellspacing="0" bordercolor="#C09B76">
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][0] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][3] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][6] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][9] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][12] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][15] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][18] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                    </tr>
                                    <tr>
                                      <td height="40" valign="middle" class="brown_bold_text">下午 (2-7:00pm)</td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][1] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][4] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][7] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][10] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][13] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][16] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][19] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                    </tr>
                                    <tr>
                                      <td height="40" valign="middle" class="brown_bold_text">晚上 (7-10:00pm)</td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][2] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][5] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][8] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][11] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][14] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][17] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                      <td align="center"> <?php if ($this->_tpl_vars['client']['timeslots'][20] == 1): ?><span class="darkgreen_bold_text">可以</span><?php else: ?><span class="brown_bold_text">---</span><?php endif; ?> </td>
                                    </tr>
                                  </tbody>
                                </table>
                                <?php else: ?>
                              ...
                              <tr>
                                <td colspan="4"><form id="form1" name="form1" method="post" action="tutor_request_do.php">
                                  <input type="hidden" name="ci" id="ci" value="<?php echo $this->_tpl_vars['ci']; ?>
" />
                                  <p class="brown_bold_text"><strong>如有任何補充您認為可以幫助成功接收這個案，請提供：</strong></p>
                                  <p>
                                    <label>
                                    <textarea name="message" cols="60" rows="5" class="black_text" id="message"></textarea>
                                    </label>
                                  </p>
                                  <p>
                                    <label>
