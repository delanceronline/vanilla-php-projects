<?php /* Smarty version 2.6.26, created on 2010-06-09 14:09:56
         compiled from tutor_register.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'tutor_register.tpl', 192, false),)), $this); ?>
                    ...
                    <tr>
                      ...
                      <td width="750" bgcolor="#FFFADD"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <?php if ($this->_tpl_vars['is_generated'] == 1): ?><input type="hidden" id="is_generated" name="is_generated" value="1" /><?php endif; ?>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td>&nbsp;</td>
                              </tr>
                              ...
                              <tr>
                                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td><input name="si_title" type="text" class="brown_text" id="si_title" maxlength="128" />
                              ...
                              <tr>
                                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    ...
                                    <td><input name="pi_hkid" type="text" class="black_text" id="pi_hkid" maxlength="16" />
                                      <span class="required_field_red_star">*</span></td>
                                  </tr>
                                  <tr>
                                    <td valign="top" class="brown_bold_text">&nbsp;</td>
                                  ...
                                  <tr>
                                    ...
                                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td width="360"><span class="brown_bold_text"><?php echo $this->_tpl_vars['recaptcha']; ?>
</span></td>
...
其他 </td>
                                  ...
                                  <tr>
                                    <td colspan="2" valign="top" class="brown_bold_text"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr>
                                        <td valign="top"> <?php $_from = $this->_tpl_vars['nt_names']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
高考純數 --- $150/小時</textarea></td>
                                  ...
                                  <tr>
                                    ...
                                    <td><select name="aq_college" class="black_text" id="aq_college">
                                      <option value="-1" selected="selected">------請選擇------</option>
								      <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['college_ids'],'output' => $this->_tpl_vars['college_names']), $this);?>
                                  ...
                                  <tr>
                                    ...
                                    <td><select name="aq_hs_major" class="black_text" id="aq_hs_major">
                                      <option value="-1" selected="selected">------請選擇------</option>                                      
								        <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['hm_ids'],'output' => $this->_tpl_vars['hm_names']), $this);?>
                                  ...
                                  <tr>
                                    ...
                                    <td><span class="brown_bold_text">
                                      <textarea name="tf_detail4" cols="60" rows="5" class="black_text" id="tf_detail4"></textarea>
                                    </span></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    <td colspan="2" valign="top" class="brown_bold_text"><textarea name="tf_detail5" cols="60" rows="5" class="black_text" id="tf_detail5"></textarea></td>
                                    </tr>
                                  <tr>
                                    <td valign="top" class="brown_bold_text">&nbsp;</td>
                                    <td>&nbsp;</td>
