<?php /* Smarty version 2.6.26, created on 2010-05-28 11:23:54
         compiled from tutor_register_ok.tpl */ ?>
...
unset($_smarty_tpl_vars);
 ?></td>
                    ...
                    <tr>
                      <td height="100" valign="middle" bgcolor="#336633" class="hd_white_bold_text">導師登記</td>
                    </tr>
                  </table></td>
                    ...
                    <tr>
                      ...
                      <td width="750" bgcolor="#FFFADD"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td>&nbsp;</td>
                          <td width="700"><br />
                            <span class="hd_brown_text">歡迎您加入成為GoodTutor一份子！</span><br />
                            <br />
                            <span class="brown_text">我們已寄出了一封電子郵件給您作驗証用途，請查看您的電子郵箱，並激活您的帳戶．<br />
                            <br />
                            當您激活了帳戶之後，我們會盡快檢閱您的導師檔案，並把它顯示給相關的學生／家長！<br />
                            <br />
                            當我們完成了檢閱導師檔案，您將會收到一組密碼用作更新導師檔案．</span><br />
                            <br />
                            <br />
                            <br />
                            <br />
                            <br />
                            <br />
                            <a href="index.php" class="brown_underline_text">返回首頁</a><br />
                            <br />
                            <br />
                            <br /></td>
                          <td>&nbsp;</td>
