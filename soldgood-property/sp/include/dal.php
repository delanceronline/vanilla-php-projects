...
class tDAL
{
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
	  $this->lstTables[]=array("name"=>"districts","varname"=>"districts");
	  $this->lstTables[]=array("name"=>"supplies","varname"=>"supplies");
	  $this->lstTables[]=array("name"=>"supply_modes","varname"=>"supply_modes");
	  $this->lstTables[]=array("name"=>"supply_types","varname"=>"supply_types");
	  $this->lstTables[]=array("name"=>"users","varname"=>"users");
	  $this->lstTables[]=array("name"=>"zones","varname"=>"zones");
	  $this->lstTables[]=array("name"=>"heights","varname"=>"heights");
	  $this->lstTables[]=array("name"=>"identity","varname"=>"identity");
	  $this->lstTables[]=array("name"=>"property_states","varname"=>"property_states");
	}
