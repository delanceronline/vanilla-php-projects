...
class ListPage extends RunnerPage 
{
	...
	function addCommonHtml() 
	{
		...
		if($this->is508) {
			$this->body["begin"].= "<a href=\"#skipdata\" title=\"".mlang_message("508_SKIP_DATA")."\" style=\"width:1px;height:1px;overflow:hidden;display:block;\">".mlang_message("508_SKIP_DATA")."</a>";
			$this->body["begin"].= "<a href=\"#skipmenu\" title=\"".mlang_message("508_SKIP_MENU")."\" style=\"width:1px;height:1px;overflow:hidden;display:block;\">".mlang_message("508_SKIP_MENU")."</a>";
			$this->body["begin"].= "<a href=\"#skipsearch\" title=\"".mlang_message("508_SKIP_SEARCH")."\" style=\"width:1px;height:1px;overflow:hidden;display:block;\">".mlang_message("508_SKIP_SEARCH")."</a>";
			$this->body["begin"].= "<a href=\"templates/helpshortcut.htm\" title=\"".mlang_message("508_HELP")."\" style=\"width:1px;height:1px;overflow:hidden;display:block;\">".mlang_message("508_HELP")."</a>";
		}
