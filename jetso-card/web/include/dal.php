...
class tDAL
{
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
	  $this->lstTables[]=array("name"=>"campaigns","varname"=>"campaigns");
	  $this->lstTables[]=array("name"=>"clients","varname"=>"clients");
	  $this->lstTables[]=array("name"=>"industries","varname"=>"industries");
