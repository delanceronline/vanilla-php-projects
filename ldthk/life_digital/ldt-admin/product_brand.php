                        ...
                        <div class="col-md-12">
                            <div class="content-box-large">
                                <div class="panel-heading">
                                    <div class="panel-title">主頁 / 產品品牌</div>
                                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" id="data-form" method="post" enctype="multipart/form-data" role="form" action="ajax/product_brand_create.php">
            ...
            $(document).ready(function() {
                ...
                var crudServiceBaseUrl = "http://demos.telerik.com/kendo-ui/service",
                        dataSource = new kendo.data.DataSource({
                            transport: {
                                read: {
                                    url: "json/product_brand_read.php",
                                    dataType: "json"
                                },
                ...
                $("#grid").kendoGrid({
                    ...
                    columns: [
                        ...
                        {field: "image", title: "Logo", width: "80px", template: kendo.template($("#img_template").html())},
                ...
                function hookConfirm() {
                    $('a.delete').click(function() {
                        ...
                        if (confirm("Confirm to delete?") == true) {
                            ...
                            $.ajax({
                                url: "ajax/product_brand_destroy.php",
                                type: "POST",
                                data: dataString,
                    ...
                    $('a.edit').click(function() {
                        ...
                        var dataString = 'id=' + id;
                        $.ajax({
                            url: "ajax/product_brand_read_1.php",
                            type: "POST",
                            data: dataString,
                            success: function(data) {
                ...
                function checkOK() {
                    if ($('#title').val() != "" && $('#sort').val() != "" && ($('#id').val() != "" || $('#image').val() != ""))
