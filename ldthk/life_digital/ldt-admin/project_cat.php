                        ...
                        <div class="col-md-12">
                            <div class="content-box-large">
                                <div class="panel-heading">
                                    <div class="panel-title">主頁 / 工程分類</div>
                                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" id="data-form" method="post" enctype="multipart/form-data" role="form" action="ajax/project_cat_create.php">
                ...
                function hookConfirm() {
                    $('a.delete').click(function() {
                        ...
                        if (confirm("Confirm to delete?") == true) {
                            ...
                            $.ajax({
                                url: "ajax/project_cat_destroy.php",
                                type: "POST",
                                data: dataString,
                    ...
                    $('a.edit').click(function() {
                        ...
                        var dataString = 'id=' + id;
                        $.ajax({
                            url: "ajax/project_cat_read_1.php",
                            type: "POST",
                            data: dataString,
                            success: function(data) {
