                                ...
                                <div class="panel-body">
                                    ...
                                    if ($link) {
                                        ...
                                        if ($db_selected) {
                                            ...
                                            $result = mysql_query("SELECT id, image from project_detail WHERE project_id = '$project_id'");
            ...
            $(document).ready(function() {
                $('a.delete').click(function() {
                    ...
                    if (confirm("Confirm to delete?") == true) {
                        ...
                        $.ajax({
                            url: "ajax/project_detail_destroy.php",
                            type: "POST",
                            data: dataString,
                            success: function(data) {
                                alert("Item deleted.");
                                window.location = "project-detail.php?project_id=<?php echo $project_id; ?>";
                            },
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                $("#uploader").plupload({
                    ...
                    url: "ajax/project_detail_upload.php?project_id=<?php echo $project_id; ?>",
                    // Maximum file size
                    max_file_size: '2mb',
                    chunk_size: '1mb',
                    filters: [
