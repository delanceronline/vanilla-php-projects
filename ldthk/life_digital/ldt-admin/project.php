                        ...
                        <div class="col-md-12">
                            <div class="content-box-large">
                                <div class="panel-heading">
                                    <div class="panel-title">主頁 / 安裝工程</div>
                                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" id="data-form" method="post" enctype="multipart/form-data" role="form" action="ajax/project_create.php">
                                    ...
                                    <select name="category" id="category">
                                        ...
                                        if ($link) {
                                            ...
                                            if ($db_selected) {
                                                ...
                                                $result = mysql_query("SELECT * from project_cat");
...
$(document).ready(function() {
    ...
    $("#grid").kendoGrid({
        ...
        columns: [
            ...
            {field: "cat_title", title: "Category", width: "90px"},
            ...
            {field: "image", title: "Image", width: "80px", template: kendo.template($("#img_template").html())},
    ...
    function hookConfirm() {
        ...
        $('a.detail').click(function() {
            window.location = "project-detail.php?project_id="+$(this).attr("data-id");
        });
    ...
    function checkOK(){
        if ($('#title').val() != "" && $('#sort').val() != "" && $('#show').val() != "" && ($('#id').val() != "" || $('#image').val() != ""))
