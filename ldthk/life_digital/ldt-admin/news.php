                        ...
                        <div class="col-md-12">
                            <div class="content-box-large">
                                <div class="panel-heading">
                                    <div class="panel-title">主頁 / 最新消息</div>
                                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" id="data-form" method="post" enctype="multipart/form-data" role="form" action="ajax/news_create.php">
...
$(document).ready(function() {
    ...
    $("#grid").kendoGrid({
        ...
        columns: [
            ...
            {field: "link", title: "Link", width: "100px"},
    ...
    function checkOK(){
        if ($('#title').val() != "" && $('#sort').val() != "" && $('#show').val() != "" /*&& $('#description').val() != ""*/)
