                        ...
                        <div class="col-md-12">
                            <div class="content-box-large">
                                <div class="panel-heading">
                                    <div class="panel-title">主頁 / Mini Banner</div>
                                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" id="data-form" method="post" enctype="multipart/form-data" role="form" action="ajax/mini_banner_create.php">
...
$(document).ready(function() {
    ...
    $("#grid").kendoGrid({
        ...
        columns: [
            ...
            {field: "link", title: "Link", width: "160px"},
    ...
    function hookConfirm() {
        $('a.delete').click(function() {
            ...
            if (confirm("Confirm to delete?") == true) {
                ...
                $.ajax({
                    url: "ajax/mini_banner_destroy.php",
                    type: "POST",
                    data: dataString,
        ...
        $('a.edit').click(function() {
            ...
            var dataString = 'id=' + id;
            $.ajax({
                url: "ajax/mini_banner_read_1.php",
                type: "POST",
                data: dataString,
                success: function(data) {
    ...
    $('#link').on('keyup change paste cut click', checkOK);

    $("#submit").attr("disabled", true);
    function checkOK(){
        if ($('#sort').val() != "" && $('#show').val() != "" && ($('#id').val() != "" || $('#image').val() != "") && $('#link').val() != "")
