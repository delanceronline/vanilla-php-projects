                ...
                <div class="row">
                        ...
                        <li class="current"><a href="#">Cloning</a></li>-->
                            ...
                            if ($link) {
                                ...
                                if ($db_selected) {
                                    ...
                                    $result = mysql_query("SELECT `title` from `product_cat` WHERE `id` = '$id'");
                    ...
                    <div class="medium-9 large-9 columns margin-bottom-mm">
                        ...
                        <div class="row" id="paging">
                            <?php include_once 'product-brand-paging.php'; ?>
                        </div>
                        <div class="clearfix"></div>
                ...
                $(document).ready(function() {
                    ...
                    function checkClick() {
                        $('.page_num').click(function(e) {
                            ...
                            if (page_no != page_now){
                                var dataArray = [<?php echo $id;?>, page_no];
                                $.ajax({
                                    url: "product-brand-paging.php",
                                    type: "POST",
